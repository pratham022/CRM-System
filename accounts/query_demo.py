...
# here tag__name => tag: name of class which is referenced as many to many field
#                   name: name of the attribute of class tag
# Here, we have class anme as tag and it has an attribute tag which gives tag name
productsFiltered = Product.objects.filter(tag__tag="Sports")
'''
(11)Bonus
